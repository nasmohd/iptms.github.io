...
<div class="container">
     <div class="row mr-auto">
        ...
        <div class="ml-5 col-lg-5 ml-auto mt-3">
            <textarea class="form-control" rows="1" style="border: 2px solid #306FA0; resize:none; border-radius" placeholder="Enter name of IPT place..." name="search_term"></textarea>
        </div>
    ...
    <div class='row mt-2 mb-2'>
        ...
        <div class='col-6 ml-auto mr-auto mb-2' style='border: 2px solid #333333; border-radius: 10px;  box-shadow: 0px 6px 6px 0px gray;' id='place_style' onclick='co_page()'>
            <div class='row'>
                ...
                <div class='col-lg-3 ml-auto mb-2'>
                        
                            <button class='btn btn-success' style='background-color: #306FA0; border: 1px solid #306FA0' id='apply_btn' onclick='applyBtn()'>More Info..</button>
