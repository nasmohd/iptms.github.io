<?php
    echo "
                   ...
                   <button class='ml-3 btn' style='background-color: #6C757D'>
                        ...
                        <textarea placeholder='Selected Student' name='selection' class='form-control col-lg-5 mt-4' id='exampleFormControlTextarea1' rows='1' maxlength='250' readonly style='resize:none;'> ".$_SESSION['SelectedStudent_FName']." ".$_SESSION['SelectedStudent_LName']."</textarea>
