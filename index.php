    ...
    <div class="container-fluid" id="div_nav"> 
        <div class="row">
            ...
            <nav class="navbar navbar-expand-lg" id="navTop">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSuppoertedContent" aria-expanded="false" aria-label="Toggle navigation">
