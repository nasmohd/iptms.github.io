...
if (($get_res['indSup_verifystatus'] == '') || ($get_res['indSup_verifystatus'] == '0')){ //If Industrial Supervisor status is empty, update
    $check_status = $_POST['check_verifyStatus'];
...
if ($get_res['indSup_verifystatus'] == '1'){ //If Industrial Supervisor status is filled, update
